...
# print rating_list # score sa ratings
...
# meetingTime = ['6:00 PM - 6:30 PM', '6:30 PM - 7:00 PM', '7:00 PM - 7:30 PM','7:30 PM - 8:00 PM', '7:00 AM - 7:30 AM']#assuming na ito muna yung output na top
#GAWAN NG PARAAN LATER. DAPATFROM RECOMMENDER SYSTEM MAG BIGAY NG 5
# print freeTime
...
up_bldg = os.path.join('up_bldg2.csv')
up_road = os.path.join('up_road2.csv')
...
# ratings = {'6:00 PM - 6:30 PM':6, '6:30 PM - 7:00 PM':7, '7:00 PM - 7:30 PM':7,'7:30 PM - 8:00 PM': 5, '7:00 AM - 7:30 AM': 5,}
print ratings
# ^ dummy ratings
...
# 				'7:00 AM - 7:30 AM': {'PALMA':min(distAtTime['7:00 AM - 7:30 AM'].values())}
				# }
score_place = {}
for time in meetingTime:
...
# print "\nRecommended Meeting Place: ", places[dist.index(minlist)]
